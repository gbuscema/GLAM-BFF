package com.glam.bff.openapi.user;
...
import com.glam.bff.openapi.user.auth.Authentication;
...
@Component("com.glam.bff.openapi.user.ApiClient")
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "http://user-service.fly.dev";
